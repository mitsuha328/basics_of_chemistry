let wordList = [
    { name: "アンモニア", formula: "NH(3)", comment: "弱塩基", check: 0 },
    { name: "水酸化ナトリウム", formula: "HaOH", comment: "強塩基", check: 0 },
    { name: "水酸化カリウム", formula: "KOH", comment: "強塩基", check: 0 },
    { name: "酸化カルシウム", formula: "CaO", comment: "", check: 0 },
    { name: "水酸化カルシウム", formula: "Ca(OH)(2)", comment: "強塩基", check: 0 },
    { name: "水酸化バリウム", formula: "Ba(OH)(2)", comment: "強塩基", check: 0 },
    { name: "酸化鉄(Ⅲ)", formula: "Fe(3)O(2)", comment: "", check: 0 },
    { name: "酸化鉄(Ⅱ)", formula: "FeO", comment: "", check: 0 },
    { name: "四酸化三鉄", formula: "Fe(3)O(4)", comment: "", check: 0 },
    { name: "水酸化鉄(Ⅱ)", formula: "Fe(OH)(2)", comment: "", check: 0 },
    { name: "水酸化鉄(Ⅲ)", formula: "Fe(OH)(3)", comment: "", check: 0 },
    { name: "酸化銅(Ⅰ)", formula: "Cu(2)O", comment: "", check: 0 },
    { name: "酸化銅(Ⅱ)", formula: "CuO", comment: "", check: 0 },
    { name: "水酸化銅(Ⅱ)", formula: "Cu(OH)(2)", comment: "", check: 0 }
]
